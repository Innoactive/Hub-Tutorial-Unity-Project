...
namespace Innoactive.HubTutorial
{
    ...
    public class CustomLightSetupMenu : Menu, IMenuProvider
    {
        ...
        private void AddButtons()
        {
            ...
            Add(new ButtonItem(new ResourceIcon("Day", "Icons/day-icon"), (controller) => SetLightSetup(0)));
            Add(new ButtonItem(new ResourceIcon("Night", "Icons/night-icon"), (controller) => SetLightSetup(1)));
        }
        ...
        private void SetLightSetup(int lightSetupIndex)
        {
            ...
            // LightSetupController.Instance.SetLight(index);
            ...
            {
                lightCommand.Invalidate();
            }

            lightCommand = new LightSetupCommand(lightSetupIndex);
